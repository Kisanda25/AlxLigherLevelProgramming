...
class Square:
    ...
    def __init__(self, size=0, position=(0, 0)):
        ...
        Raises:
            ...
            ValueError: If size is less than 0 or position is not a tuple of two positive integers.
        """
        self.size = size
    ...
    def position(self, value):
        ...
        Raises:
            ...
            ValueError: If position is not a tuple of two positive integers.
        """
    ...
    def my_print(self):
        ...
        The position is used to adjust the indentation of the square.
        """
        if self.__size == 0:
            print()
        else:
